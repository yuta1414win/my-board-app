...
- [ ] `/board` に直接アクセスすると `/auth/signin` にリダイレクトされる
- [ ] `/profile` に直接アクセスすると `/auth/signin` にリダイレクトされる
- [ ] `/settings` に直接アクセスすると `/auth/signin` にリダイレクトされる
...
- [ ] ログイン済みで `/auth/signin` にアクセスすると `/board` にリダイレクトされる
